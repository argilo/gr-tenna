...
class gotenna_pro_tx_bladerf(gr.top_block):
    ...
    def __init__(self, baud_rate=9600, callsign='VE3IRR', counter_num=0, frequency=450000000, message='Hello world!', message_type='BROADCAST', publickey_data='base64key', recipient_gid=1234567891, sender_gid=1234567890):
        ...
        self.bladeRF_sink_0.set_center_freq(center_freq,0)
        ...
        self.connect((self.blocks_multiply_xx_1, 0), (self.bladeRF_sink_0, 0))
    ...
    def set_center_freq(self, center_freq):
        ...
        self.bladeRF_sink_0.set_center_freq(self.center_freq, 0)
